...
const evalFuc = async () => {
	...
	with(sandbox){
/*embed script begin*/
		let pic  = await snapshotByElement('http://index.1688.com/alizs/keyword.htm?userType=purchaser&cat=15','//em[contains(text(),"日用百货")]','.hot>div.content:nth-child(2)',[0,0,0,-87],'url',{
